...
| Group | **ABQ Community** | **$291 for 3 months — $97/month, paid up front** (REVISED 2026-08-21). One payment, not a subscription: it ends. Members who want to stay opt in to **$37/month**, set up by hand. The old "3 × $97/mo or $250 one-pay (save $41) → $47/mo" model is dead — Mighty Networks could not express it and checkout moved to Stripe. **$291 = 3 × $97 on purpose**, preserving the homepage "start for $97" symmetry with the 1:1 session. | For people who won't buy 1:1 (preference or budget). Weekly calls + 24/7 support. Standalone product — NOT bundled with packages. 3-month structure matches "transformation takes 3–6 months." Replaces $97-launch/$147-regular/discount-code apparatus entirely. |
