...
- **Homepage — AS BUILT (reconciled 2026-08-21).** Actual order: hero (headline + one line only) → **guide opt-in as its own section (1b)** → recognition (four stage cards) → transformation-not-abstinence → **"What Makes The Difference"** (Jon's verbatim copy, restored) → guide/qualifications → **"What Jon Offers" (6a: the two services named, no prices)** → **"How You Start" (6b: the Two Doors, "Either way, you start for $97")** → proof → **stakes (StoryBrand beat 7)** → final CTA/tagline. **No FAQ — cut entirely 2026-08-14 (Jon).** The 6a/6b split exists because a single combined section was announcing the offerings *and* the entry price at once, so neither service registered. **(2026-07-12) The homepage does NOT advertise the $1,200 Program.** The 1:1 door sells only the $97 "just meet with Jon" session and links OUT to the standalone $97 sales page (Jon assesses fit and sells the Program in-session); the $97 fee is **NOT credited toward anything (reversed 2026-08-14)**. See offer-architecture.md "Homepage & $97 Positioning."
- **/coaching — AS BUILT (reconciled 2026-08-21).** Both offers are present: the **$1,200 Program leads** in the offer section (it is the gold standard), with the **$97 meeting as the no-commitment option** alongside it. Landing-v2 structure and copy carried over; Katherine's long-form testimonial restored under its live-site heading; stakes close; FAQ **approved by Jon 2026-08-14**. One-per-person rule stated; **no credit toward anything (reversed 2026-08-14)**. Final CTA is evergreen — one button, no booking embed, no dated copy. Program checkout is a Stripe Payment Link (`PROGRAM_URL`); the $97 door links out to the standalone landing page (`SESSION_URL`).
- **/community — AS BUILT (reconciled 2026-08-21).** Bones stay (four-stage qualifier, FAQ, antidote close). Pricing is **$291 for 3 months, $97/month paid up front** — one payment, not a subscription. **🚨 The rationale wording in the original spec — *"we ask for 3 months because that's how long transformation takes"* — is BANNED.** Jon rejected it as an implied promise and it violates site rule 3. Use: *"Three months is a commitment to yourself and to the process of quitting, which takes time."* There is no $47 tail, no auto-continue and nothing to cancel: the membership **ends**, and members who want to stay opt in to **$37/month** by hand. Codes and regular-price apparatus deleted. No refunds, stated plainly.
